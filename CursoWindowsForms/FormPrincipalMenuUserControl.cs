...
{
    public partial class FormPrincipalMenuUserControl : Form
    {
        int ControleHelloWolrd = 0;

        public FormPrincipalMenuUserControl()
        {
            InitializeComponent();
        }
        ...
        {
            ControleHelloWolrd += 1;
            FormHelloWordUserControl u = new FormHelloWordUserControl();
            TabPage tab = new TabPage();
            tab.Name = "Hello World";
            tab.Text = "Hello World " + ControleHelloWolrd;
            tab.ImageIndex = 1;
            tab.Controls.Add(u);
            TbcAplicacoes.TabPages.Add(tab);
        }
